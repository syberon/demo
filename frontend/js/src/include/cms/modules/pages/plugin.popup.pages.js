...
window.addEventListener('load', function () {
    let template = `
        <div class="modal fade" id="pages-structure-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Выбор родительского раздела</h5>
    ...
    let selector = '.get-structure-field';
    let elTarget;
    ...
    function setValue(node) {
        if (node) {
            document.querySelector(`[name='${elTarget}']`).value = node.data.href;
